 ...
 ******************************************************************************/
    ...
    https: {
      key: require("fs").readFileSync('/etc/letsencrypt/live/iot.depermana.com/privkey.pem'),
      cert: require("fs").readFileSync('/etc/letsencrypt/live/iot.depermana.com/fullchain.pem')
    },
     ...
     */
    httpNodeAuth: {user:"depermana",pass:"hash"},
